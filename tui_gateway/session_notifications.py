...
# _KANBAN_NOTIFY_KINDS is imported from gateway.kanban_watchers_notifier (one source of truth).
# Kanban, /loop + /heartbeat, and the bot mailbox share one idle-poll cadence.
